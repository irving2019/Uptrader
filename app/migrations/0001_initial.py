    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_DEFAULT, to='app.TreeMenu', verbose_name='Родительский элемент')),
            ],
            options={
                'verbose_name': 'Меню',
